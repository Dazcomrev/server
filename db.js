...
const pool = new Pool({
    connectionString: 'postgresql://postgres:[YOUR-PASSWORD]@db.yvpdbfltdhkgyleomnkz.supabase.co:5432/postgres',//'postgresql://postgres:123456@localhost:5432/EsportInCompetition',
